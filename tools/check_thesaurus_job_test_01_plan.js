...
assert.equal(plan.ranked_record_window, 20);
...
console.log("OK campaign=THS-01 revision=2 tasks=20 categories=4 records=20 family-window=5 artifact=sim-47 frozen=true");
