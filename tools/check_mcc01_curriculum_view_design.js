...
assert.equal(fs.existsSync(path.join(root, "tables", "mappings", "optimization-problem-structure.md")), false);
assert.equal(fs.existsSync(path.join(root, "tables", "procedures", "prototype-test-iteration.md")), false);
...
console.log("OK campaign=MCC-01 designs=2 owners=2 anchors=0 relations=0 tables=0 sources=7 boundaries=optimization/prototype");
