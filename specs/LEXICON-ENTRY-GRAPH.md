# Lexicon Entry Graph V0

Status: draft

## Purpose

Lexicon is read as books and tables but maintained as a typed graph. Every
...
Lexicon uses `prime` and `composite` as view-relative roles:
...
Lexicon supports progressive disclosure, but tiers are navigational views,
...
1. a stable canonical Lexicon entry identifier;
...
2. search Lexicon and external references;
