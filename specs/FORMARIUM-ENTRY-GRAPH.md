# Formarium Entry Graph V0

Status: draft

## Purpose

Formarium is read as books and tables but maintained as a typed graph. Every
...
Formarium uses `prime` and `composite` as view-relative roles:
...
Formarium supports progressive disclosure, but tiers are navigational views,
...
1. a stable canonical Formarium entry identifier;
...
2. search Formarium and external references;
