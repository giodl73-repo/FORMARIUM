# Candidate Entry Drafts

These files exercise the full Lexicon entry grammar before canonical
admission. They are not Tables, canonical records, search results, graph
identities, or reader-evidence claims.

A draft may move to `tables/entries/` only after its literature brief,
source/domain review, fixed-point role review, graph and catalog validation,
and recurring reader need all pass.

Validate the complete noncanonical corpus from the repository root:
...
- [Similarity, Difference, Analogy, Equivalence, and Match](similarity-difference-analogy-equivalence-match.md)
- [Privacy, Confidentiality, Secrecy, Anonymity, and Disclosure](privacy-confidentiality-secrecy-anonymity-disclosure.md)
- [Trust, Credibility, Reputation, Legitimacy, and Reliance](trust-credibility-reputation-legitimacy-reliance.md)
...
- [Stance, Tone, Voice, Mood, and Atmosphere](stance-tone-voice-mood-atmosphere.md)
- [Metaphor, Metonymy, Symbol, Allegory, and Allusion](metaphor-metonymy-symbol-allegory-allusion.md)
- [Persona, Self-Presentation, Mask, Disguise, and Avatar](persona-self-presentation-mask-disguise-avatar.md)
- [Pattern, Regularity, Motif, Template, and Pattern Formation](pattern-regularity-motif-template-pattern-formation.md)
- [Register, Style, Genre, Variety, and Idiolect](register-style-genre-variety-idiolect.md)
- [Type, Token, Instantiation, Realization, and Embodiment](type-token-instantiation-realization-embodiment.md)
- [Morpheme, Inflection, Derivation, Compounding, and Word Formation](morpheme-inflection-derivation-compounding-word-formation.md)
