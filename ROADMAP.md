...
1. maintain `sim-37` as the two-book front door with dedicated Tables A-Z,
   five-part Reader contents, static Reader continuation across its 24 selected
   Tables, reciprocal family navigation, and ownership-aware search, while
   retaining exact `sim-36` custody;
