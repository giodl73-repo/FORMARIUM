...
1. maintain `sim-35` as the two-book front door plus canonical A-Z browse,
   reciprocal family navigation, and ownership-aware search, while retaining
   exact `sim-34` custody;
