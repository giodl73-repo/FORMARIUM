...
1. maintain `sim-36` as the two-book front door with dedicated Tables A-Z and
   five-part Reader routes, reciprocal family navigation, and ownership-aware
   search, while retaining exact `sim-35` custody;
