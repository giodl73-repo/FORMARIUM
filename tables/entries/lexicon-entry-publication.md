...
Lexicon publication is the governed progression from a research question to
...
| Source authority vs. Lexicon maturity | both support trust | external ownership of claims vs. editorial confidence in organization |
...
- [Entry Publication Procedure](../procedures/lexicon-entry-publication.md) owns the
  ordered workflow and recovery.
- [Editorial Maturity Scale](../scales/lexicon-editorial-maturity.md) owns status
  interpretation.
...
2. Keep research and authority claims separate from Lexicon organization.
...
| Reference form | Typical contribution | Lexicon delta |
|---|---|---|
...
| Lexicon | Links Procedure and Scale views to one publication anchor | Makes recovery, authority, and unresolved findings visible |

## Constraints and failure signs

- Every substantial entry begins from a decision-supporting research question.
- Sources own their domain claims; Lexicon owns only its organization.
...
Lexicon publication method remains `candidate`.
